...
function HighlightAdminCard({
  h: { HighlightName, HighlightID, img1 },
  onDelete,
}) {
  const handleDelete = () => {
      ...
      <div className="guideline-card flex flex-wrap pb-2 mb-2 lg:flex-nowrap mt-2 px-7 justify-between align-middle shadow-lg rounded-md my-4">
        <div className="guide_details flex gap-4 p-3">
          <div className="max-w-[70px]">
            {" "}
            <img src={`../../${img1 || { pro }}`} alt="" className="" />
          </div>
          <div>
        ...
        <div className="guide-buttons mt-5">
          ...
          <Link to={`/highlightadminup/${HighlightID}`}>
...
export default HighlightAdminCard;
