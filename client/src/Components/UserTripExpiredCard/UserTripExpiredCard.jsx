...
function UserTripExpiredCard({
  ...
  return (
    isExpired && (
      <>
        <div className="flex flex-col w-[1000px]  mx-auto mb-4 border rounded-lg shadow-md p-2 bg-gray-100 ">
          {" "}
          <div className="flex gap-5">
            ...
            <div className="flex flex-col">
              ...
              <div className=" flex flex-col justify-between gap-7">
                <div className="trip-details-first flex flex-row px-4 gap-4">
                  {tripDetails && (
                    <h2>
              ...
              <div className="trip-details-second flex  px-4  gap-4">
                {" "}
                <p>
          ...
          <fieldset className="border-[1px] mt-6 bg-slate-50 flex flex-col  align-middle justify-center gap-3">
            ...
            {guidelines &&
              guidelines.map((g) => {
                return (
                  <div className="bg-slate-50 flex justify-center align-middle px-4 py-2 shadow-xl  mb-3  w-fit rounded-md border-[1px] mt-2 mx-2">
...
export default UserTripExpiredCard;
